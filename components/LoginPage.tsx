...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-magnolia-50 via-white to-gray-50 p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl p-8 md:p-10 border border-gray-100">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-sm">Sign in to access your flight training portal</p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          ...
          <div className="space-y-2 text-xs text-gray-600">
            <div className="flex justify-between items-center bg-gray-50 px-3 py-2 rounded-md">
              ...
              <span className="text-gray-500">student@example.com / password</span>
            </div>
            <div className="flex justify-between items-center bg-gray-50 px-3 py-2 rounded-md">
              <span className="font-medium">Instructor</span>
              <span className="text-gray-500">instructor@example.com / password</span>
            </div>
            <div className="flex justify-between items-center bg-gray-50 px-3 py-2 rounded-md">
              <span className="font-medium">Admin</span>
              <span className="text-gray-500">admin@magnolia.com / password</span>
            </div>
          </div>
        </div>
      </div>
